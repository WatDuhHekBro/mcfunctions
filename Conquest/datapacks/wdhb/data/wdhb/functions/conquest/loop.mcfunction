...
execute as @e[type=armor_stand,tag=post,tag=red] at @s run particle dust 1 0 0 1 ~ ~1 ~ 0.1 0.5 0.1 0 15 force
execute as @e[type=armor_stand,tag=post,tag=blue] at @s run particle dust 0 0 1 1 ~ ~1 ~ 0.1 0.5 0.1 0 15 force
execute as @e[type=armor_stand,tag=post,tag=!red,tag=!blue] at @s run particle dust 1 1 1 1 ~ ~1 ~ 0.1 0.5 0.1 0 15 force
